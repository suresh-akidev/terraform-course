...
Go to AWS Mgmt Console -> Services -> S3 -> terraform-terraform-course -> workspaces -> terraform.tfstate
```
...
Go to AWS Mgmt Console -> Services -> S3 -> terraform-terraform-course -> env:/ -> dev -> workspaces -> terraform.tfstate
```

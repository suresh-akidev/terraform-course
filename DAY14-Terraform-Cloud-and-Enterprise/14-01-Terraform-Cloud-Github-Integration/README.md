...
git clone https://github.com/terraform-course/terraform-cloud-demo1.git
```
...
https://github.com/terraform-course/terraform-cloud-demo1.git
```
...
- **Email Address:** terraform-course@gmail.com
...
- **Connect to VCS**
  ...
  - **Selected 1 Repository:** terraform-course/terraform-cloud-demo1
  - Click on **Install**
- **Choose a Repository**
  - terraform-course/terraform-cloud-demo1
- **Configure Settings**
